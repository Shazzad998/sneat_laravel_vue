...
>
  <head>
    ...
    @vite(["resources/assets/auth/css/demo.css",
    ...
    @vite(["resources/assets/auth/vendor/libs/perfect-scrollbar/perfect-scrollbar.css",
    ...
    <!-- Helpers -->
    @vite('resources/assets/auth/vendor/js/helpers.js')


    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->

    @vite('resources/assets/auth/js/config.js')
  ...
  <body>
    ...
    @vite(["resources/assets/auth/vendor/libs/jquery/jquery.js",
    ...
    @vite('resources/assets/auth/vendor/libs/apex-charts/apexcharts.js')

    <!-- Main JS -->

    @vite('resources/assets/auth/js/main.js')
